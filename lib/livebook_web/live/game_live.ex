defmodule LivebookWeb.GameLive do
    ...
    <div style={page_style()}>
      ...
      <div class="flex">
        ...
        <div style={arena_style()}>
          ...
          >
          <span style={"position: relative; bottom: -#{player.size}px"}><%= player.name %></span></div>
  ...
  defp player_style(%{size: size, powered: powered} = player) when powered > 0, do:
  ...
  defp fruit_style({_, {size, :power_up}} = fruit), do:
